...
# Retirement note (v19, 2026-06-06, same-day)

v18 superseded same-day by human-directed §38 (next-work selection over a
unified open-items register, DORA-first then core-job value). v14–v18 changes
remain unscored — carry all scoring to the next retro (s005 delivery).
