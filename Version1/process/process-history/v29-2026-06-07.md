...
---
# Retirement note (v30, 2026-06-07)
v29 superseded by human-directed failure-taxonomy refinement: 5xx = external
failing (jittered exponential backoff; if WE own the failing service, raise a
defect task); 4xx = caller's problem. Routed to engineer/tester/architect/
product defs + the taxonomy section.
