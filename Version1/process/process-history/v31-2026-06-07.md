...
supersedes: v30
status: superseded by v32 (2026-06-07, focused retro: changes-as-experiments)
---

# Retirement note — anticipated-vs-observed scoring (done at the v32 retro)

| Change | Anticipated | Observed | Score |
|--------|-------------|----------|-------|
| v31 §12a shared change-impact model (+ 4 agent-def routings, IMP-007, OI-31) | tester < 900s median; CFR via impact-aware testing; 0 §19-class misses | No scoring opportunity yet (same-day retro; zero slices validated under it) | ACTIVE — enters experiments.md with horizon 2 scoring opportunities |

v32 was a same-day meta-change: it did not alter v31's content, it added the
experiment lifecycle that will score v31 (and everything else routed anywhere).
DORA unchanged between snapshots: lead=3618s freq=6/day cfr=35% mttr=1794s
constraint=tester.
