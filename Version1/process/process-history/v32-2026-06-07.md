...
supersedes: v31
status: superseded by v33 (2026-06-07, focused retro: use-case flow / deploy-per-UC)
---

# Retirement note — scoring at the v33 retro

| Change | Anticipated | Observed | Score |
|--------|-------------|----------|-------|
| v32 §25a changes-as-experiments | registry maintained + acted on | Registry scored at the s005-h2 slice retro same day (2 validated, 1 new row) and again mid-s006; being used, not ornamental | ON TRACK (EXP-008 1/3 retros) |

No rule reverted. DORA at retirement: lead=3618s freq=6/day cfr=32% mttr=2033s
constraint=tester. v33 adds §11a use-case flow (deploy-per-UC done condition);
v32 content otherwise carried verbatim.
