...
_Generated 2026-06-17T22:19:04Z from ledger.csv. Do not hand-edit._

## Four key metrics — CUMULATIVE (whole pipeline)

| Metric | Value | Window |
|--------|-------|--------|
| Gross lead time (median) | 2566 s | 29 slice(s) |
| Deployment frequency | 6 /active-day | 12 day(s) |
| Change failure rate (deploys only) | 20 % | 14/71 deploys |
...
| Metric | Value | Window |
|--------|-------|--------|
| Gross lead time (median) | 1506 s | 2 slice(s) |
