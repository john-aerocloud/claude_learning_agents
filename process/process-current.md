...
unstated). Mechanism: `DEFECT-OAG-062` carries the executable limb — a reported population
without a declared unit FAILS — and §17c binds it: the acceptance is the check firing on an
undeclared count, not this rule being written down [EXP-126].
