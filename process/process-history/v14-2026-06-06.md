...
# Retirement note (v15, 2026-06-06, same-day)

v14 superseded same-day by human-directed structural additions (§32 improvement
slices, §33 tool-over-permission, §34 chunk plan). v14's own changes (§28–31)
are NOT yet scored — carry their scoring to the next retro.
