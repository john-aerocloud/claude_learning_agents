...
# Retirement note (v21, 2026-06-06, same-day)

v20 superseded same-day by human-directed §40 (use-case flags for parallel
engineering — flags and branches in code, not source-control isolation).
All v14–v20 scoring carries to the s005 retro.
