...
# Retirement note (v23, 2026-06-06, focused retro)

v22 superseded by v23 at a human-invoked focused retro (question: why wasn't
missing tooling fixed at point of use). §33 amended: agents CREATE the
committed tooling their role needs in-slice; flag only what they cannot own.
Full v14–v22 scoring still deferred to the s005 delivery retro.
