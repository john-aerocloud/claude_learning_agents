...
The architect's delta names when a mechanism is new; the engineer's route places
the contract test / browser probe and schedules the thin early deploy it
implies; the tester carries ≥1 browser-transport spec and an honest harness.
...
# Retirement note (v28, 2026-06-06)

v27 superseded by human-directed principle 02 (local standability + engineer
browser tests in the build phase). §17 gains the local half; detail in
principles/02 + engineer/solution-architect defs.
