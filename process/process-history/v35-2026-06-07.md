...
supersedes: v34
status: superseded by v36 (2026-06-07, s008 retro: EXP-011 final score + simplicity-metric reframe)
---

# Retirement note (scored at the s008/v36 retro)
| Change | Anticipated | Observed | Score |
|---|---|---|---|
| v35 §9a gate-4 timing (EXP-012) | 0 deploys before their gate answer | s008: gate-4 obtained/auto-approved cleanly at app-only diff, no slip; but only 1 opportunity (1 app-only slice) | ACTIVE 1/2 (clean so far) |
DORA at retirement: lead=3972s freq=9/day cfr=26% mttr=2033s constraint=tester.
C4 chunk completed this slice (done-condition 2.3s vs 5min).
