...
> **[v72 anticipated-vs-observed, added at v73 snapshot 2026-07-01]** Anticipated:
> CFR — no un-renderable diagram ships as "done"; the `make render-diagrams` gate
> catches parse errors before close. Observed (v72→v73 window): the render gate held
> — the SLC-031 reconciliation records show `render-diagrams 23/23` / `render 23/0`
> green across the O-wave closes; zero diagram defects this window. v72 (EXP-088)
> reads as WORKING on first evidence. The v73 retro was driven by a DIFFERENT class
> (ledger close-drift), not a v72 regression.
